...
| :-------: | ---- | ----------- | :-------------: | :----: |
| 0         | [libft](https://codeberg.org/twennyfour/libft) | An implementation of some libc functions and extras, using pointer arithmetic only | 19.2 | 100 |
...
| 3         | [fly-in](https://codeberg.org/twennyfour/fly-in) | A drone routing simulator in Python -- uses Dinic's max-flow algorithm to route drones through a capacity-constrained graph in the fewest turns | 1.6 | 125 |
| 3         | [call_me_maybe](https://codeberg.org/twennyfour/call_me_maybe) | An LLM function calling tool in Python -- uses constrained decoding to turn prompts into schema-valid JSON function calls | 1.5 | 121 |
| 4         | [NetPractice](https://codeberg.org/twennyfour/NetPractice) | A set of networking exercises -- covers IP addressing, subnetting, gateways and routing | 6.3 | wip |
| 4         | [RAG against the machine](https://codeberg.org/twennyfour/RAG_against_the_machine) | A RAG system in Python that answers questions about a codebase -- covers chunking, lexical retrieval and grounded answer generation | 2.0 | wip |
| 4         | [pac-man](https://codeberg.org/twennyfour/pac-man) | A Pac-Man clone in Python -- covers ghost AI, generated levels and highscores | 1.5 | wip |
